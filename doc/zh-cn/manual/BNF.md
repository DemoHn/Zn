...
```
‹程序›         ::=  [‹导入语句›  [‹间隔符›  ‹导入语句›]*]?   ‹执行块›

‹执行块›       ::=  ‹输入语句›*    ‹语句块›    [‹拦截语句›  [‹间隔符›  ‹拦截语句›]*]?
...
‹如何语句›     ::=  如何  'ID  ？  ^[[已知  'ID  [、  'ID]*]?  ‹换行符›  ‹语句块›]  [‹换行符›  接到  'ID  ：  ^‹语句块›]*

‹构造器语句›   ::=  如何  新建  'ID  ？  ^[[已知  'ID  [、  'ID]*]?  ‹换行符›  ‹语句块›]  [‹换行符›  接到  'ID  ：  ^‹语句块›]*
...
‹比较表达式›   ::=  ‹赋值表达式›  [[等于  |  ==  |  不等于  |  /=  |  小于  |  <  |  不小于  |  >=  |  大于  |  >  |  不大于  |  <=  |  为  |  不为]  ‹比较表达式›]*
